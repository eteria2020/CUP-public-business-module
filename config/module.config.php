    ...
    'console' => [
        'router' => [
            'routes' => [
                ...
                'business-export-registries' => [
                    'type' => 'simple',
                    'options' => [
                        'route' => 'business-export registries [--dry-run|-d] [--no-customers|-c] [--no-businesses|-b] [--no-invoices|-i] [--all|-a] [--no-ftp|-f] [--test-name|-t] [--date=] [--fleet=]',
                        'defaults' => [
                            '__NAMESPACE__' => 'CUPPublicBusinessModule\Controller',
                ...
                'business-credit-card-expiry' => [
                    'type' => 'simple',
                    'options' => [
                        'route' => 'business credit card expiry',
                        'defaults' => [
                            '__NAMESPACE__' => 'CUPPublicBusinessModule\Controller',
                            'controller' => 'Console',
                            'action' => 'business-credit-card-expiry'
                        ]
                    ]
                ],
            ]
